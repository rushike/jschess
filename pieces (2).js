...
export function no_piece(props){
...
export function piece_svg(i, size){
...
// export { __PIECE_FN_SVG, wK, wQ, wR, wB, wN, wP, bK, bQ, bR, bB, bN, bP}
export const __PIECE_FN_SVG = [
                                wK, wQ, wR, wB, wN, wP, no_piece, no_piece,
                                bK, bQ, bR, bB, bN, bP, no_piece, no_piece
                                ]
export default  piece_svg;